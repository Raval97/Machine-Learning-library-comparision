...
class DecisionTreeClassSL extends Component {
    constructor() {
        super();
        this.state = {
            splitter:"best",
    ...
    render() {
        ...
        let splitterSelector = (
            <InputGroupPattern
                text={"Criterion"}
                infoText={"The strategy used to choose the split at each node. Supported\n" +
...
DecisionTreeClassSL.propTypes = {
    actualizeHyperparameters: PropTypes.any
};

export default DecisionTreeClassSL;
